...
func Version(v string) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func VersionEQ(v string) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldVersion), v))
	})
}
...
func VersionNEQ(v string) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func VersionIn(vs ...string) predicate.Object {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func VersionNotIn(vs ...string) predicate.Object {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func VersionGT(v string) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func VersionGTE(v string) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func VersionLT(v string) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func VersionLTE(v string) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func VersionContains(v string) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func VersionHasPrefix(v string) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func VersionHasSuffix(v string) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func VersionIsNil() predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func VersionNotNil() predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func VersionEqualFold(v string) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func VersionContainsFold(v string) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func HasVulnerabilities() predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func HasVulnerabilitiesWith(preds ...predicate.Vulnerability) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasReport() predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ReportTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, ReportTable, ReportPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasReportWith(preds ...predicate.Report) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
