...
func (m *RuleMutation) SetAction(s string) {
	m.action = &s
}

// Action returns the value of the "action" field in the mutation.
func (m *RuleMutation) Action() (r string, exists bool) {
	v := m.action
	if v == nil {
		return
	}
...
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RuleMutation) OldAction(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *RuleMutation) SeverityIDs() (ids []int) {
...
func (m *RuleMutation) ResetSeverity() {
	m.severity = nil
...
func (m *RuleMutation) AddedEdges() []string {
	...
	if m.severity != nil {
		edges = append(edges, rule.EdgeSeverity)
	}
	return edges
}
