...
// The AuthStateCacheFunc type is an adapter to allow the use of ordinary
// function as AuthStateCache mutator.
type AuthStateCacheFunc func(context.Context, *ent.AuthStateCacheMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AuthStateCacheFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.AuthStateCacheMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AuthStateCacheMutation", m)
	}
	return f(ctx, mv)
}
...
// Mutate calls f(ctx, m).
func (f PackageRecordFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
...
// The VulnStatusFunc type is an adapter to allow the use of ordinary
// function as VulnStatus mutator.
type VulnStatusFunc func(context.Context, *ent.VulnStatusMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f VulnStatusFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.VulnStatusMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.VulnStatusMutation", m)
	}
	return f(ctx, mv)
}
